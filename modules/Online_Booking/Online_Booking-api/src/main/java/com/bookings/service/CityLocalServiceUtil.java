 ...
 * <code>com.bookings.service.impl.CityLocalServiceImpl</code> and
...
public class CityLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.bookings.service.impl.CityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new city
	 */
	public static City createCity(long city_id) {
	 ...
	 */
	public static City deleteCity(long city_id) throws PortalException {
	...
	public static City fetchCity(long city_id) {
	 ...
	 * @throws PortalException if a city with the primary key could not be found
	 */
	public static City getCity(long city_id) throws PortalException {
		return getService().getCity(city_id);
	}

	public static List<City[]> getCityAllTable() {
		return getService().getCityAllTable();
	}

	public static List<Object[]> getCityObject() {
		return getService().getCityObject();
	}

	public static List<City[]> getCityThird(String cityname) {
		return getService().getCityThird(cityname);
	}
