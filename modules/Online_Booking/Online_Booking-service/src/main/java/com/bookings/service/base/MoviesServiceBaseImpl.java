...
/**
 * Provides the base implementation for the movies remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bookings.service.impl.MoviesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.bookings.service.impl.MoviesServiceImpl
 * @generated
 */
public abstract class MoviesServiceBaseImpl
	extends BaseServiceImpl implements IdentifiableOSGiService, MoviesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MoviesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MoviesServiceUtil</code>.
	 */
	 ...
	 */
	public com.bookings.service.Movies_CityService getMovies_CityService() {
	 ...
	 */
	public void setMovies_CityService(
		com.bookings.service.Movies_CityService movies_CityService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(moviesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MoviesService.class.getName();
	}
	...
	private void _setServiceUtilService(MoviesService moviesService) {
		try {
			Field field = MoviesServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, moviesService);
		}
	...
	@BeanReference(type = MoviesService.class)
	...
	@BeanReference(type = com.bookings.service.Movies_CityService.class)
	protected com.bookings.service.Movies_CityService movies_CityService;
